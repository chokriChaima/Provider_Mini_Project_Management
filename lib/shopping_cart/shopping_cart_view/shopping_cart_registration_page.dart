      ...
      body: Padding(
        ...
        child: BlocListener<ShoppingCartBloc, ShoppingCartState>(
            ...
            child: ListView(children: [
              ...
              SizedBox(
                  height: SizePresets.of(context).customHeight(10, context)),
              Text(
              ...
              SizedBox(
                  height: SizePresets.of(context).customHeight(50, context)),
              ...
              Text("If you don't have a shopping cart create one",
                  textAlign: TextAlign.center,
                  style: Theme.of(context).textTheme.bodyMedium),
              SizedBox(
                  height: SizePresets.of(context).customHeight(55, context)),
              AppButton(
                  text: "Create",
                  onPressed: () => context
